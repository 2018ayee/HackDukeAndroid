...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    Schedule[] myDataset = {new Schedule("Check-In", "9:00 AM - 10:45 AM", "Schiciano Atrium", 36.003448, -78.939482),
            ...
            new Schedule("Team Formation Mixer", "2:00 PM - 2:30 PM", "Schiciano Foyer", 36.003448, -78.939482),
            new Schedule("Workshop Session 1", "2:00 PM", "Hudson Hall", 36.004169, -78.940937),
            new Schedule("Workshop Session 2", "3:00 PM", "Hudson Hall", 36.004169, -78.940937),
            ...
            new Schedule("Workshop Session 3", "4:00 PM", "Hudson Hall", 36.004169, -78.940937),
            new Schedule("Mixer for Female-Identifying and Non-Binary Hackers", "6:00 PM - 7:00 PM", "Innovation Co-Lab", 36.003910, -78.938278),
            new Schedule("Dinner", "6:30 PM - 8:00 PM", "Schiciano Foyer", 36.003448, -78.939482),
            ...
            new Schedule("Spicy Noodle Challenge", "11:00 PM - 11:45 PM", "Schiciano Foyer", 36.003448, -78.939482),
            new Schedule("Midnight Snacks", "12:00 AM - 8:00 AM", "Twinnie's", 36.0034683, -78.9395882),
            new Schedule("Nap Time", "12:00 AM - 8:00 AM", "-"),
            new Schedule("Breakfast", "9:00 AM - 9:45 AM", "Schiciano Foyer", 36.003448, -78.939482),
            new Schedule("Workshops", "10:00 AM - 12:00 PM", "Locations TBA"),
            new Schedule("Lunch", "12:00 PM - 1:30 PM", "Schiciano Foyer", 36.003448, -78.939482),
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.addMarker(new MarkerOptions().position(duke).title("Duke University"));
